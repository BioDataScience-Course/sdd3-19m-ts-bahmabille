...
plot(co2_trend_test)
#histogramme :  p calculé grâce a l'air sous la courbe (qui relierait les sommets de tous les barres verticales de l'histogramme) aux extremités du pointillé. aire sous la courbe à l'extremité droite de l'histogramme est trèès faible, p<alpha==>on rejette Ho==> il y a une tendance significative. Ligne verticale pointillée éloingnée des barres verticales de l'histogramme. pointille = valeur du coeff de corrélation observé dans la série non réechantillone. plus le pointillé est extreme à gauche ou à droite dans la série plus on a tendance à penser que Ho est moins plausible=> tendance à rejetter Ho (==>pas de tendance globale).
