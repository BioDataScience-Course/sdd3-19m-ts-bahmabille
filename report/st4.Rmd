...
#avec ses lignes vertivales on voit si palliers correspondent a limites entre differentes masses d'eau: ici oui: palliers significatifs."
...
tser.sin <- lm(nottem ~ I(cos(2*pi*Time)) + I(sin(2*pi*Time_nottem)))
