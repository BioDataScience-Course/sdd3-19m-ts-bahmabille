...
trend.test(nottem) # Valeur p = 0.41 (valable uniquement si pas d'autocarrelation) / attention car pas d independance des valeurs les unes des autres!!!
# Même test, mais par bootstrap (mieux!) => R = 999, rééchantillonage 999x, sacahant qu'il y a en une qui est la serie initiale
...
plot(x2)
# Transformation en objet 'ts' ('serie temporelle')
x2.ts <- as.ts(x2)
plot(x2.ts)
