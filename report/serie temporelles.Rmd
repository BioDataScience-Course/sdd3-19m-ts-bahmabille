...
trend.test(schizo) # Valeur p-value = 4.946e-16, le seuil alpha est de 5%, ici la p-value est nettement plus faible donc on ne rejette H0, la différence est donc significative. Pas interessant de faire un simple test de correlation ds serie spatio-temporelle, car d'office il devrait y en avoir. Donc le bootstrap nettement plus important.
