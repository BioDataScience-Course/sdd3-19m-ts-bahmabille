...
cycle(schizo_ts)
#Si les observations etaient faite sur plusieurs années, la fonction cycle agirait en numerotant tous les mois de janvier 1, février = 2, etc. Dans le cas du jeu de données schizo, les observation ne sont ni annuelles, ni mensuelles... dans la console toutes les observations sont numerotées 1. L'utilisation de la fonction cycle n'est pas justifie ici.
...
# Split separe la série en fonction des cycles. $'1' = toutes les mesure du mois de janvier, $'2' = février, etc. Ici toutes les observations sont reprises dans $`1` puisqu'il n'y a pas plusieurs cycles. L'utilisation de la fonction split n'est pas justifie ici.
